...
def word_extractor():
    ...
    words = re.findall(r'\w+' , paragraph.lower())  # convert to lowercase to avoid case differences
...
def particle_distance():
    ...
    regular_expressionn = r'^-?\d+'  # Matches negative and positive integers
    sorted_points = []
...
def cleaning_and_counting():
    ...
    print(cleaned_text.lstrip())  # Print cleaned text for debugging
